...
$count=0;
$sql = "SELECT * from book,publisher where name like '$email%' and book.pub_id =publisher.pub_id "; 
...
echo "<center><table border='3' style='border-color: green; cellspacing='8' cellpadding='13'>
<tr>

<th border='2'>Publisher</th>
...
if($count==0)
{
	echo "<br><br><center>SORRY! NO Publisher found...</center>";
	echo '<br><br><center><a href="publisher.php"> Go Back</a></center>';
